...
import { DailyDealsData } from "../../utils/daily-deals.js";
...
function DailyDeals() {
  ...
  const pageCount = Math.ceil(DailyDealsData.length / productsPerPage);
  const offset = currentPage * productsPerPage;
  const currentProducts = DailyDealsData.slice(offset, offset + productsPerPage);
      ...
      <div className="container">
        <div className="flex items-center justify-between gap-5 mb-6 max-md:mb-8">
          <div className="flex flex-wrap items-end gap-3 max-md:flex-col max-md:items-start max-md:gap-1.5">
            <h3 className="text-3xl font-bold capitalize max-sm:text-lg">Daily Deals Products</h3>
