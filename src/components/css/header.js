export const header={
    container:'flex justify-between items-center p-2 py-4 text-sm',
    ...
    dropdown:'text-base capatalize font-semibold cursor-pointer hover:text-green-600 flex justify-evenly align-center'
}
